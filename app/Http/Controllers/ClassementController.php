    ...
    public function index()
{
    $classements = Classement::with('inscrit')
        ->orderByDesc('points')   // 🔥 Trie du plus grand au plus petit
        ->orderBy('bc', 'asc')    // En cas d’égalité, celui avec moins de buts contre monte
        ->get();

    return view('classement', compact('classements'));
}
