        ...
        <div class="grid md:grid-cols-2 gap-10">
            ...
            <div class="info-card p-8">
                ...
                <ul class="space-y-3 text-gray-300">
                    ...
                    <li><strong class="text-green-400">💰 Frais de participation :</strong> {{ $tournois->caution }} FCFA</li>
                ...
                <div class="mt-8 flex flex-wrap gap-4">
                    <a href="{{ route('participant.tournois') }}"
                       class="btn-secondary px-5 py-2 rounded-lg transition text-sm">
                       ⬅️ Retour
                    </a>

                    <a href="{{ route('envoyer.create', ['id' => $tournois->id]) }}"
        ...
        <div class="mt-16">
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="info-card p-6">
                    ...
                    <p class="text-gray-400">Prix pour les 3 premiers </p>
                </div>
                <div class="info-card p-6">
                    <h4 class="text-lg font-semibold text-green-400 mb-2">📞 Contact</h4>
                    <p class="text-gray-400">Pour plus d'informations : <a href="https://wa.me/+22952739802" class="text-green-400 hover:underline">Contactez-nous</a></p>
                </div>
            </div>
        </div>
    </div>
