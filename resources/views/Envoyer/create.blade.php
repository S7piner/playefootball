...
<div class="container">
    <div class="card">
        ...
        <div class="info-box">
            ...
            <p><strong>MTN :</strong> 0152739802 (Stephane Wilson)</p>
            <p><strong>Moov :</strong> 0160778076 (Stephane Wilson)</p>
            <p><strong>Celtis :</strong> 0143417301 (Mafouss)</p>
            <p><strong>Montant :</strong>{{ $tournoi->caution }} FCFA</p>
        </div>

        <form action="{{ route('envoyer.store', ['id' => $tournoi->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
